...
// Dev
//#define VALUE_API_PREFIX   @"http://dev.o2omarketing.cn:9004/RateLetterInterface"
// Test
#define VALUE_API_PREFIX   @"http://test.o2omarketing.cn:9100/RateLetterInterface"

//O2O
#elif APP_TYPE == APP_TYPE_O2O
#define VALUE_API_PREFIX   @"http://112.124.68.147:5032"
...
// TODO 正式接口
#define API_SERVICE_EXTEND      @"&type=Product"
#define API_SERVICE_USER        @"User/UserHandler.ashx?action="
#define API_USER_LOGIN          @"Login"
#define API_GET_USER_LIST       @"GetUsers"
#define API_MODIFY_USER_INFO    @"ModifyUser"
#define API_MODIFY_USER_PSWD    @"ModifyPassword"

#define API_SERVICE_GROUP       @"Group/GroupHandler.ashx?action="
#define API_GROUP_CREATE        @"CreateGroup"
#define API_GROUP_ADD_USER      @"AddUserGroup"
#define API_GROUP_GET_LIST      @"GetGroupList"
#define API_GROUP_GET_DETAIL    @"GetIMGroupsInfo"
#define API_GROUP_GET_USER      @"GetGroupUsers"
#define API_GROUP_UPDATE        @"UpdateIMGroupInfo"
#define API_GROUP_DELETE        @"DeleteGroup"
#define API_GROUP_DEL_USER      @"DelUserGroup"

//过期接口
#define API_SERVICE_USER_DEL        @"UserService"
#define API_NAME_USER_PROFILE       @"UserProfile"
#define API_NAME_USER_SIGN_IN       @"signIn"
#define API_NAME_USER_MODIFYIMAGE   @"ModifyHighImage"
...
#define O2O_CLOUD_SERVER_BASE_URL    @"http://www.o2omarketing.cn:9004/Lj/data/data.aspx"
...
#define KEY_API_NAME_GET_VIP_DETAIL  @"getVipDetail"
#define KEY_API_NAME_GET_ITEM_KEEP   @"getItemKeep"
#define KEY_API_NAME_GET_VIP_TAGS    @"getVipTags"
...
#define KEY_API_PARAM_OPEN_ID        @"openId"
...
#define API_SERVICE_ACTION     @"action"

#define KEY_GET_HOT_ATTENTION  @"GetEventStats"
