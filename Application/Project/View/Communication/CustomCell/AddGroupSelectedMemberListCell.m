...
@implementation AddGroupSelectedMemberListCell {
    UserObject *_userProfile;
    AddGroupMemberListCell *_friendListCell;
...
- (void)updateView:(UserObject *)userProfile withRect:(CGRect)rect
{
    [self drawAvatar:userProfile.userName];
}
...
- (void)drawAvatar:(NSString *)imageUrl {
    if (imageUrl && imageUrl.length > 0 ) {
        ...
        _avataImageView.image = IMAGE_WITH_IMAGE_NAME(@"groupCellDefaultHeader.png");
    }
}
