...
- (void)initCellOfHeader {
    ...
    _headerImage = [[GHImageView alloc] initWithFrame:CGRectMake(headerImageOriginX, headerImageOriginY, HEADER_IMAGE_WIDTH, HEADER_IMAGE_HEIGHT) defaultImage:@"groupCellDefaultHeader.png"];
