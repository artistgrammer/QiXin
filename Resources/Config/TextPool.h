...
//  ProductFramework
//
//  Created by MobGuang on 13-10-15.
...
static NSString *const NSLoadWelfareFailedMsg = @"loadWelfareFailedMsg";
...
static NSString *const NSSkinSwitchDoneMsg = @"skinSwitchDoneMsg";
...
static NSString *const NSHomeTitle          = @"homeTitle";
static NSString *const NSEventTitle         = @"eventTitle";
static NSString *const NSLearnTitle         = @"learnTitle";
static NSString *const NSChatGroupTitle     = @"chatGroupTitle";
