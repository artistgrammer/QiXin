...
+ (sqlite3 *)prepareBizDB {
    ...
    /*
     ...
     @property (nonatomic, copy) NSString *userName; //中文名
     @property (nonatomic, copy) NSString *userNameEn; //英文名
     @property (nonatomic, copy) NSString *chatId; //
     @property (nonatomic, copy) NSString *customerId; //
     @property (nonatomic, copy) NSString *userImageUrl; //头像
     @property (nonatomic, copy) NSString *userTel;
     @property (nonatomic, copy) NSString *userEmail; //邮件
     @property (nonatomic, copy) NSString *userStatus; //
     @property (nonatomic, copy) NSString *userCode; //
     @property (nonatomic, copy) NSString *groupId; //
     @property (nonatomic, copy) NSString *userDept; // 部门
     @property (nonatomic, copy) NSString *userTitle; // 头衔
     @property (nonatomic, copy) NSString *userRole; // 角色
     @property (nonatomic, assign) int isFriend;
     @property (nonatomic, assign) int isDelete;
     @property (nonatomic, assign) int userGender;
     */
	imgStmt = [self statementWithQuery:"create table if not exists user (userId TEXT PRIMARY KEY, userName TEXT, userNameEn TEXT, chatId TEXT, customerId TEXT, userImageUrl TEXT, userTel TEXT, userEmail TEXT, userStatus TEXT, userCode TEXT, groupId TEXT, userDept TEXT, userTitle TEXT, userRole TEXT, isFriend int, isDelete int, userGender int, userCellphone TEXT, userBirthDay TEXT, superName TEXT);"];
    ...
    /*
     ...
     @property (nonatomic, assign) int userGender;
     */
	imgStmt = [self statementWithQuery:"create table if not exists chat_group_user (groupId TEXT, userId TEXT, chatId TEXT, userName TEXT, userNameEn TEXT, customerId TEXT, userImageUrl TEXT, userCode TEXT, isDelete int, PRIMARY KEY(groupId, userId, chatId));"];
    
    ret = [imgStmt step];
	if (ret != SQLITE_DONE) {
		debugLog(@"Failed to create 'chat_group_user' table.");
		NSAssert1(0, @"Failed to create 'chat_group_user' table.", nil);
	}
    //------------------------------------------------------------
    ...
    //--------------------------------courseListInfo-----------------------------
    imgStmt = [self statementWithQuery:"create table if not exists courseListInfo (courseID integer ,courseTitle TEXT, courseType integer, chapterNumber integer, isMyCourse integer default 0, categoryID integer, isDelete integer, PRIMARY KEY(courseID));"];
    ret = [imgStmt step];
	if (ret != SQLITE_DONE) {
