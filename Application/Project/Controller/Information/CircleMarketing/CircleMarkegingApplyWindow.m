...
- (id)initWithType:(AlertType)type {
    ...
    if ( self = [super init]) {
        ...
        if (SCREEN_HEIGHT > 480.f) {
            viewFrame = CGRectMake(SCREEN_WIDTH*0.1,SCREEN_HEIGHT*0.15, SCREEN_WIDTH*0.8, SCREEN_HEIGHT*0.4);
        }else
            viewFrame = CGRectMake(SCREEN_WIDTH*0.1,SCREEN_HEIGHT*0.15 - 10.f, SCREEN_WIDTH*0.8, SCREEN_HEIGHT*0.35);
