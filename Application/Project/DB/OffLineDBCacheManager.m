...
//    [self.descriptors addObject:sortDesc];
    ...
    //    	else
    {
        ...
        //        [infoList updateDataWithObject:detail];
        infoList.trainingCourseID = NUMBER(couseId);
        [[ProjectDBManager instance] updateCourseDetailList:infoList];
        [[ProjectDBManager instance] updateCourseChapters:infoList MOC:MOC];
        
        DLog(@"%d", infoList.chapterLists.count);
        
        //        for (ChapterList *chapter in detail.chapterLists) {
        //
        //            ChapterList *im = (ChapterList *)[NSEntityDescription insertNewObjectForEntityForName:@"ChapterList" inManagedObjectContext:MOC];
        //            [im updateDataWithObject:chapter];
        //            [infoList addChapterListsObject:im];
        //        }
    }
...

{
    ...
    ChatGroupModel *group =(ChatGroupModel *)  [WXWCoreDataUtils hasSameObjectAlready:MOC
    ...
    if (group) {
        ...
        group = (ChatGroupModel *)[NSEntityDescription insertNewObjectForEntityForName:@"ChatGroupModel" inManagedObjectContext:MOC];
        [group updateDataWithStmt:queryStmt];
    }
...
{
    UserBaseInfo *userInfo = [[ProjectDBManager instance] getUserInfoByUserIdFromDB:privateUserId.integerValue];
