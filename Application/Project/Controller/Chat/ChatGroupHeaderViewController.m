//
//  ChatGroupHeaderViewController.m
//  Project
//
...
@interface ChatGroupHeaderViewController ()<UIActionSheetDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate>

@end

@implementation ChatGroupHeaderViewController {
...
-(void)initControl
{
    int imageWidth = SCREEN_WIDTH / 2.0f;
    int imageHeight = imageWidth;
    
    int startX = (SCREEN_WIDTH - imageWidth) / 2.0f;
    int startY = 40;
    
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(startX, startY, imageWidth, imageHeight)];
    _imageView.image = IMAGE_WITH_NAME(@"communication_group_cell_default_avata.png");
...
-(void)downloadFile:(ChatGroupModel *)dataModal
{
    _downloadFile = [CommonMethod getLocalDownloadFileName:dataModal.groupImage withId:dataModal.groupId];
