...
#define TAG_DEMO_GOTO_VideoConf     105
...
#define TAG_DEMO_GOTO_ContactBackup 111

#define DEMO_CURRENT_VOIP  @"demo_current_voip"
...
- (void)loadView
{
    ...
    for (int i=0;i<11;i++)
    {
        ...
        {
            [self createBlackViewWithRect:CGRectMake(x-103, y, 92, 92) andText:@"视频" andBGView:scrollView];
        }
        else if (i == 6)
        {
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (![[defaults objectForKey:DEMO_CURRENT_VOIP] isEqualToString:self.modelEngineVoip.voipAccount])
    {
        [defaults setObject:self.modelEngineVoip.voipAccount forKey:DEMO_CURRENT_VOIP];
