...
-(void)loadView
{
    ...
    UIImageView *imgPhone = [[UIImageView alloc] initWithFrame:CGRectMake(16.f, 65, 250.f, 40.f)];
    imgPhone.image = [UIImage imageNamed:@"input_box1@2x.png"];
    [self.view addSubview:imgPhone];
    [imgPhone release];
    
    UITextField* tf1 = [[UITextField alloc] initWithFrame:CGRectMake(19.f, 65.f, 244.f, 40.f)];
    ...
    chooseContactsBtn.frame = CGRectMake(275.f, 65, 40.f, 40.f);
...
{
    if (reason.reason == ERequestType_NetError)
    {
    ...
    else if (reason.reason == ERequestType_XmlError)
    {
