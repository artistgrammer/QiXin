...
@interface CircleMarketingEventCommentViewController ()<CircleMarkegingApplyWindowDelegate, WXWCustomeAlertViewDelegate, UITextViewDelegate> {
    BOOL submited;
...
- (void)submitComment:(UIButton *)sender {
    ...
    //    [customeAlertView updateInfo:_eventDetailList];
    [customeAlertView resetContentView:@"发布评论"];
    [customeAlertView show];
    
    //    [PXAlertView showAlertWithTitle:@"发布评论"
    //                            message:nil
    //                        cancelTitle:@"取消"
    //                         otherTitle:@"确定"
    //                        contentView:[self commentView]
