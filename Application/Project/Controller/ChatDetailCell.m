...
@interface ChatDetailCell() <WXWImageFetcherDelegate, SDWebImageManagerDelegate, CMPopTipViewDelegate, WXWImageDisplayerDelegate>
{
...
//@synthesize userNameLabel = self.userNameLabel;
...
//@synthesize secbubbleLabel;
//@synthesize isListenImage;
...
- (void)drawChat:(IMMessageObj*)message row:(NSInteger)row showTime:(BOOL)showTime {
	...
	if(self.isSelf) {
        ...
        self.userNameLabel.text = [[AppManager instance].chatUserDict objectForKey:message.sender];
    }
    
    // TODO
//    self.userNameLabel.text = self.muserInfo.chName;
