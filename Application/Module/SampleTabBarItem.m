...
#define ICON_SIDE_LENGTH_W      45.f    //20.0f
#define ICON_SIDE_LENGTH_H      45.f    //20.0f
#define IMAGE_OFFSET_Y          4+18

//选择中后，字体是否变色
#define HIGHLIGHT_COLOR         HEX_COLOR(@"daa44a")
#define NORMAL_COLOR            [UIColor whiteColor]
#define TEXT_OFFSET_Y                2

#define BADGE_HEIGHT    16.0f

@implementation SampleTabBarItem
...
- (id)initWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        // TODO
        //    _titleLabel.colorName = @"kTabBarTitleLabel";
