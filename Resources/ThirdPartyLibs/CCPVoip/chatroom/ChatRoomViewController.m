...
-(void)createChatroomWithChatroomName:(NSString*)chatroomName andPassword:(NSString *)roomPwd andSquare:(NSInteger)square andKeywords:(NSString *)keywords inAppId:(NSString*)appid andIsAutoClose:(BOOL)isAutoClose;
{
    statusView.text =@"连接中，请稍后....";
    [self.modelEngineVoip startChatroomWithName:chatroomName andPassword:roomPwd andSquare:square andKeywords:keywords inAppId:appid andIsAutoClose:isAutoClose];
    [self displayProgressingView];
}
