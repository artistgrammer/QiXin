...
@interface SearchUserByWebViewController ()<UIWebViewDelegate> {
...
@implementation SearchUserByWebViewController
...
- (void)startSearch:(NSDictionary  *)dict
{
    ...
    NSString *url = [ProjectAPI getRequestURL:API_SERVICE_USER_DEL withApiName:API_NAME_USER_PROFILE withCommon:commonDict withSpecial:specialDict];
