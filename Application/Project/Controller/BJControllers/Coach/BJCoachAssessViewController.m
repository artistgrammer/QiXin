...
@implementation BJCoachAssessViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"Assess";
...
//    
//    NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"CoachAssessTotalCell" owner:self options:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else
    {
        ...
        if (cell ==nil) {
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"CoachAssessCell" owner:self options:nil];
            //        if ([nib count] > 0) {
