//
//  BJCoachLikeDislikeViewController.h
//  Project
//
...
@interface BJCoachLikeDislikeViewController : BaseListViewController
{
...
@property (nonatomic, assign) NSInteger mLikeDislikeFlag;
