...
#define TRANS_SENDER_DATA               @"sender"
#define TRANS_ATTACH_TYPE               @"attachType"
#define TRANS_ATTACH_SPECIAL_DATA       @"special"

#define TRANS_SEND_NAME                 @"Name"
#define TRANS_SEND_NAMEID               @"UserId"
#define TRANS_SEND_IMAGE                @"Image"

#define TRANS_IMAGE_WIDTH               @"ImageWidth"
#define TRANS_IMAGE_HEIGHT              @"ImageHeight"

#define TRANS_MAP_LATITUDE              @"MapLatitude"
#define TRANS_MAP_LONGITUDE             @"MapLongitude"
#define TRANS_MAP_TITLE                 @"MapTitle"
#define TRANS_MAP_ZOOMLEVEL             @"MapZoomLevel"
...
typedef enum{
    EMessageAttachType_IMAGE = 100,
    EMessageAttachType_LOCATION,
    EMessageAttachType_OTHER
} EMessageAttachType;
...
@property (nonatomic, copy) NSString *chatGroupId; //自己服务器ID
@property (nonatomic, copy) NSString *logoUrl; //
@property (nonatomic, copy) NSString *desc; //描述
@property (nonatomic, copy) NSString *email; //描述
@property (nonatomic, copy) NSString *groupWebsite; //website
@property (nonatomic, copy) NSString *customerID; //e703dbedadd943abacf864531decdac1
@property (nonatomic, copy) NSString *tel; //12345678901
@property (nonatomic, copy) NSString *groupLevel; //
@property (nonatomic, copy) NSString *isPublic; //
@property (nonatomic, copy) NSString *approveNeededLevel; //
@property (nonatomic, copy) NSString *invitationLevel; //
@property (nonatomic, copy) NSString *chatLevel; //
@property (nonatomic, copy) NSString *quitLevel; //
